...
| [`async_requests`](#async-requests) | bool _(optional)_ | **Default:** `false` <br /><br /> When set to `true`, All the requests would be made non-blocking (Async). |
| [`http_client_handler`](#http-client-handler) | string _(optional)_ | **Default:** `Telegram\Bot\HttpClients\GuzzleHttpClient` <br /><br /> Path to custom HTTP Client Handler which should be an instance of `Telegram\Bot\HttpClients\HttpClientInterface`. |
